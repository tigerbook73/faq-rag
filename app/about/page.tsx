    ...
    <div className="flex-1 min-h-0 overflow-y-auto">
      <div className="max-w-3xl md:w-[80%] w-full mx-auto px-4 py-8 space-y-6">
        ...
        <p className="text-muted-foreground">
          FAQ-RAG is a local knowledge base Q&amp;A system powered by Retrieval-Augmented Generation.
          Upload documents in Chinese or English, then ask questions in either language and receive
          streamed answers with cited source chunks.
        </p>
