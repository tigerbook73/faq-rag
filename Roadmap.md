...
> 使用Claude Code实施的时候的规则：

- 按照顺序执行其中的子项目
- 不需要写计划，直接执行
- 非危险操作无需确认，直接执行
- 每个实施子项目完成后，git add，但不需要 commit，等确认后再提交
- 前面一个子项目未完成前，不要开始下一个子项目，保持专注
...
| 类别                                          | 项目数 | 完成 | 建议先做 |
| --------------------------------------------- | ------ | ---- | -------- |
| [RAG 核心质量](#一rag-核心质量)               | 6 项   | 6 ✅ | —        |
| [Next.js / React 技能](#二nextjs--react-技能) | 5 项   | 5 ✅ | —        |
| [用户体验 / 缺失功能](#三用户体验--缺失功能)  | 8 项   | 8 ✅ | —        |
| [可靠性 / 生产就绪](#四可靠性--生产就绪)      | 9 项   | 9 ✅ | —        |
| [代码质量](#五代码质量)                       | 4 项   | 4 ✅ | —        |
| [测试](#六测试)                               | 3 项   | 3 ✅ | —        |
...
阶段 5（UX 补全，2–3 天）✅ 全部完成
  §3-E  对话导出                     ✅
  §3-G  文档失败错误内联显示         ✅
  §3-H  Rebuild All 进度反馈         ✅
  §2-E  多轮对话上下文管理           ✅

阶段 6（测试 + 高阶 RAG，5–10 天）✅ 全部完成
  §6-A  检索管道单元测试             ✅
  §6-B  Playwright E2E 测试          ✅
  §1-F  语义分块                     ✅
  §6-C  嵌入质量对比实验             ✅
```
...
### 1-F ✅ 语义分块（Semantic Chunking）【已完成】
